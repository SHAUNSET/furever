    ...
    <section className="relative w-full min-h-[calc(100vh-96px)] overflow-hidden bg-[#FFF8F0] flex flex-col">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(#181D27 1px, transparent 1px)",
      ...
      <div className="relative flex-1 w-full max-w-none px-4 sm:px-8 lg:px-12 xl:px-16 pt-6 sm:pt-8 lg:pt-10 pb-4 sm:pb-6 flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-8 sm:gap-12 lg:gap-16 xl:gap-20 w-full items-stretch flex-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3.5 sm:gap-4 mb-8 sm:mb-10 w-full sm:w-auto">
                ...
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.03,
                    boxShadow:
                      "0 20px 40px -10px rgba(255,92,53,0.4)",
                  }}
                  whileTap={{ scale: 0.98 }}
              ...
              >
                {VALUES.map(({ icon: Icon, label }) => (
                  ...
                  >
                    <Icon
                      size={15}
                      className="text-[#00A878] shrink-0"
                    />

                    <span className="text-[13px] sm:text-[14px] font-bold text-[#181D27]">
                      {label}
                    </span>
                  </div>
                ))}
          ...
          <div className="relative h-full min-h-[400px] sm:min-h-[480px] md:min-h-[520px] w-full mt-6 lg:mt-0 flex flex-col justify-center">
            ...
            >
              <p className="text-[#181D27] text-[12px] sm:text-[14px] font-extrabold leading-snug">
                Made Responsibly
              </p>

              <p className="text-[#718096] text-[10px] sm:text-[12px] font-medium mt-0.5">
                Ethical production
              </p>
            </motion.div>
            ...
            >
              <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-[#FF5C35]/15 flex items-center justify-center shrink-0">
                <Package
                  size={15}
                  className="text-[#FF5C35] sm:w-[18px] sm:h-[18px]"
                />
              </div>
              ...
              <div>
                ...
                <p className="text-[#718096] text-[10px] sm:text-[11px] font-medium">
                  Zero waste
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-[#00A878]/15 flex items-center justify-center shrink-0">
                <Sparkles
                  size={15}
                  className="text-[#00A878] sm:w-[18px] sm:h-[18px]"
                />
              </div>
            ...
            >
              <ShieldCheck
                size={16}
                className="text-[#00A878] shrink-0 sm:w-[18px] sm:h-[18px]"
              />

              <span className="text-white text-[11px] sm:text-[13px] font-bold tracking-wider uppercase">
        ...
        >
          {[
            ...
            >
              ...
              <PawPrint
                size={12}
                className="text-[#FF5C35] sm:w-[14px] sm:h-[14px]"
                fill="currentColor"
                strokeWidth={0}
              />
            </span>
